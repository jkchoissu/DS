  ...
  // insert Position declaration here...
    ...
    public:
      ...
      E& operator*()	const					// get element
        { return v->elt; }
      bool operator==(const Position& p) const		// are positions equal?
        { return v == p.v; }
      bool operator!=(const Position& p) const		// are positions not equal?
        { return v != p.v; }
      Position left() const						// get left child
        { return Position(v->left); }
      Position right() const					// get right child
        { return Position(v->right); }
      void setLeft(const Position& p) const		// set left child
        { v->left = p.v; v->left->par = v; }
      void setRight(const Position& p) const 	// set right child
        { v->right = p.v; v->right->par = v; }
...
//  Position removeAboveExternal(const Position& p);	// remove p and parent
  ...
  void setRoot(const Position& p) {						// set new root node
	  _root->left = p.v;
	  _root->left->par = _root;
  }
  ...
  static void BinaryPreorderPrint(const BinaryTree& T, const Position& p) {
  	cout << *p << " ";
  ...
  static void BinaryPostorderPrint(const BinaryTree& T, const Position& p) {
  	if (!p.noLeft())							// traverse left subtree
  ...
  static void BinaryInorderPrint(const BinaryTree& T, const Position& p) {
  ...
  static void BinaryParenPrint(const BinaryTree& T, const Position& p) {
  ...
  static void countLeftExternalNodes(const BinaryTree& T, const Position& p, int& countLeft) {
	if (!p.noLeft()) {
