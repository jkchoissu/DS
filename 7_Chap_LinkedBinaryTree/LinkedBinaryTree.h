...
template <typename E>
//typedef int E;					// base element type
...
//  Position removeAboveExternal(const Position& p);	// remove p and parent
  ...
  void expandExternal(const Position& p, const E& left_e, const E& right_e) {							// expand external node
  Node* v = p.v;					// p's node
  ...
  void BinaryPreorderPrint(const LinkedBinaryTree& T, const Position& p) {
  	cout << *p << " ";
  ...
  void BinaryPostorderPrint(const LinkedBinaryTree& T, const Position& p) {
  	if (!p.noLeft())							// traverse left subtree
  ...
  void BinaryInorderPrint(const LinkedBinaryTree& T, const Position& p) {
  ...
  void BinaryParenPrint(const LinkedBinaryTree& T, const Position& p) {
